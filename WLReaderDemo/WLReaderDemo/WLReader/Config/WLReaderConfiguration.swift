...
/// 默认左侧间距
let WL_READER_HORIZONTAL_MARGIN:CGFloat = 20.0
/// 章节列表的宽度
...
// 到下一页
let WL_READER_TO_NEXT_PAGE_NOTIFICATION = "WL_READER_TO_NEXT_PAGE_NOTIFICATION"
// 到上一页
let WL_READER_TO_PREVIOUS_PAGE_NOTIFICATION = "WL_READER_TO_PREVIOUS_PAGE_NOTIFICATION"
